...
/mob/living/say(var/message, var/datum/language/speaking = null, var/verb="says", var/alt_name="", var/alt_message=null, var/animal = FALSE, var/howl = FALSE, var/original_message = "")
	if (client)
		if (client.prefs.muted & MUTE_IC)
			...
			return
	var/static/regex/memes = regex("метагей|тритор|павергейм|повергейм|генокрад|брейнрот|лол|кек|азаза|ванотян|вуна|лолечка|фоллач|фолач|хостинг|анкап|анкапа|коклав|конкап|анкал|рофляныч|рофелька|футанари|фута|камбой|фембой|майнкрафт|чумба|чушка|чурка|флоппа|флопа|либерахи|либераха|либераху|траповод|тритор|метагей||двач|рпшер|спидранер|лабеб|лутецкий|залутать|лутер|спидран|спидранить|заспидранил|хорни|вайб|фури|фурятина|фуричка|вайбов|вайбер|чирик|ванотян|сорри|коксакингом|коксакинг|коксак|коксакер|сорян|соряныч|сорямба|рофлябма|рофлыч|ауе|ролевой плей|ролевой рп|жигуль|жигули|жигулик|pog|поггерс|погчамп|ролеплеер|ральплеер|кек|кекыч|кекчик|грифер|грифонер|грифозник|хентай|тяночка|лоля|вайфу|lmao|ayy|lol|kek|cheburek|ежжи|спанчбоб|рофл|uwu|owo|0w0|@w@|>w<|обэма|>w>|blacklivesmatters|BLM|вуася|алейкум|украина|зеленский", "i")
