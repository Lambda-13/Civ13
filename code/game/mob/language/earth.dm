...
#define SPANISH_SYLLABLES list ("ad", "al", "an", "ar", "as", "ci", "co", "de", "do", "el", "en", "er", "es", "ie", "in", "la", "lo", "me", "na", "no", "nt", "on", "or", "os", "pa", "qu", "ra", "re", "ro", "se", "st", "ta", "te", "to", "ue", "un", "en", "de", "er", "es", "ue", "la", "ra", "os", "nt", "te", "ar", "qu", "el", "ta", "do", "co", "re", "as", "on", "an", "to", "lo", "st", "un", "or", "ad", "ie", "se", "ci", "al", "pa", "na", "ro", "no", "me", "in", "aci", "ada", "ado", "ant", "ara", "ci�", "com", "con", "des", "dos", "ent", "era", "ero", "est", "ido", "ien", "ier", "i�n", "las", "los", "men", "nte", "nto", "par", "per", "por", "que", "res", "sta", "ste", "ten", "tra", "una", "ver", "que", "ent", "nte", "con", "est", "ado", "par", "los", "era", "ien", "men", "per", "sta", "ara", "una", "por", "i�n", "tra", "ant", "nto", "ero", "ci�", "aci", "las", "com", "ste", "res", "ten", "ier", "ver", "dos", "des", "ido", "ada")
...
#define GREEK_SYLLABLES list("do", "rik", "ev", "ti", "on", "t�", "ka", "phi", "o�", "en", "et", "tn", "pn", "k�", "ev", "a�", "�o", "se", "pa", "na", "tes", "pan", "he", "w�d", "p�m", "me", "ee", "w�i", "s")
...
#define BLACKSPEECH_SYLLABLES list("sh","thr", "th", "m", "Kr", "gl", "sk", "zg", "mb", "mp", "rz", "nk", "dhl", "zh", "�", "a", "�k", "ul", "ak", "na", "ul", "ag", "Ng", "gh", "h", "s", "z")
