...
/obj/item/weapon/paper/proc/show_content(var/mob/user, var/forceshow=0)
	if (!(istype(user, /mob/living/human) || isghost(user) && !forceshow))
		user << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[stars(info)][stamps]</BODY></HTML>", "window=[name]")
		onclose(user, "[name]")
	else
		user << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[info][stamps]</BODY></HTML>", "window=[name]")
		onclose(user, "[name]")
...
*/
		...
		usr << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[info_links][stamps]</BODY></HTML>", "window=[name]") // Update the window
...
/*
		...
		user << browse("<meta charset='utf-8'><HEAD><TITLE>[name]</TITLE></HEAD><BODY>[info_links][stamps]</BODY></HTML>", "window=[name]")
		return
