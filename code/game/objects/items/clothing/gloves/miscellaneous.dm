...
/obj/item/clothing/gloves/thick/combat //Combined effect of SWAT gloves and insulated gloves
	...
	icon_state = "black"
	item_state = "swat_gl"
	armor = list(melee = 80, arrow = 15, gun = ARMOR_CLASS, energy = 25, bomb = 50, bio = 10, rad = FALSE)
...
/obj/item/clothing/gloves/thick/swat //Combined effect of SWAT gloves and insulated gloves
	...
	icon_state = "swat"
	item_state = "swat"
	armor = list(melee = 80, arrow = 15, gun = ARMOR_CLASS*2, energy = 25, bomb = 50, bio = 10, rad = FALSE)
	siemens_coefficient = FALSE
...
/obj/item/clothing/gloves/thick/salamon //Combined effect of SWAT gloves and insulated gloves
	...
	icon_state = "salamon"
	item_state = "salamon"
	armor = list(melee = 50, arrow = 15, gun = ARMOR_CLASS, energy = 25, bomb = 50, bio = 10, rad = FALSE)
	siemens_coefficient = FALSE
