...
/datum/category_item/player_setup_item/general/body/content(var/mob/user)
	if (ishuman(user) && user.stat != DEAD)
		. += "<center><font size='5' color='red'><b>ВЫ НЕ МОЖЕТЕ ИЗМЕНИТЬ НАСТРОЙКИ ПЕРСОНАЖА ВО ВРЕМЯ ИГРЫ!</b></font><br><br>"
		. += "<font size='2' color='red'>Возращайся после смерти.</font></center>"
	else
		...
		if (has_flag(mob_species, HAS_SKIN_TONE))
			. += "<b>Цвет кожи: </b><a href='?src=\ref[src];skin_tone=1'>[-pref.s_tone + 35]/220</a><br>"
		. += "<br>"
		...
		if (has_flag(mob_species, HAS_HAIR_COLOR))
			. += "<b>Цвет:</b> <a href='?src=\ref[src];hair_color=1'>[pref.hair_color]</a>"
		. += "<br><b>Стиль:</b> <a href='?src=\ref[src];hair_style=1'>[pref.h_style]</a><br>"
		...
		if (has_flag(mob_species, HAS_HAIR_COLOR))
			. += "<b>Цвет:</b> <a href='?src=\ref[src];facial_color=1'>[pref.facial_color]</a>"
		. += "<br><b>Стиль:</b> <a href='?src=\ref[src];facial_style=1'>[pref.f_style]</a><br>"
		...
		if (has_flag(mob_species, HAS_EYE_COLOR))
			...
			. += "<b>Цвет:</b> <a href='?src=\ref[src];eye_color=1'>[pref.eye_color]</a>"
		. += "<br><br>"
		. += "(<a href='?src=\ref[src];random=1'>Рандомизировать тело</A>)<br><br>"
		. += "<b>Всегда рандомизировать тело:</b> <a href='?src=\ref[src];always_random_body=1'>[pref.be_random_body ? "Yes" : "No"]</a>"
