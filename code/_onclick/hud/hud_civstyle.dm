/datum/hud/human/civstyle
	...
	HUDneed = list(
		"health"	  = list("type" = /obj/screen/health,	 "loc" = ui_health, "icon" = ui_hud_health_1713),
		"nutrition"   = list("type" = /obj/screen/nutrition,  "loc" = ui_nutrition),
		"mood"  			 = list("type" = /obj/screen/mood,	   "loc" = ui_mood),
		...
		"equip"	   = list("type" = /obj/screen/equip,	  "loc" = ui_equip),
		"intent"	  = list("type" = /obj/screen/intent,	 "loc" = ui_intent),
		"help"		= list("type" = /obj/screen/fastintent/help,	 "loc" = ui_help),
		"disarm"	  = list("type" = /obj/screen/fastintent/disarm,   "loc" = ui_disarm),
		"harm"		= list("type" = /obj/screen/fastintent/harm,	 "loc" = ui_harm),
		"grab"		= list("type" = /obj/screen/fastintent/grab,	 "loc" = ui_grab),
		"random damage zone" = list("type" = /obj/screen/zone_sel_random,   "loc" = ui_random_damage_zone),
		"damage zone" = list("type" = /obj/screen/zone_sel3,   "loc" = ui_damage_zone, "icon" = ui_hud_zone_sel_1713),
		"swap hand"   = list("type" = /obj/screen/swap,	   "loc" = ui_swap_hand),
