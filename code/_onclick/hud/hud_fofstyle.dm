/datum/hud/human/fofstyle
	...
	HUDneed = list(
		"health"	  = list("type" = /obj/screen/health,	 "loc" = ui_health, "icon" = ui_hud_health_FoF),
		...
		"intent"	  = list("type" = /obj/screen/intent,	 "loc" = ui_harm),
		"random damage zone" = list("type" = /obj/screen/zone_sel_random,   "loc" = ui_random_damage_zone),
		"damage zone" = list("type" = /obj/screen/zone_sel3,   "loc" = ui_damage_zone, "icon" = ui_hud_zone_sel_FoF),
