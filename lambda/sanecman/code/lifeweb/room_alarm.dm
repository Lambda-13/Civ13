...
/obj/machinery/emergency_room
	name = "Alarm button"
	desc = ""
	icon = 'lambda/sanecman/icons/obj/monitors.dmi'
	icon_state = "ealarm0"
...
/obj/machinery/emergency_room/process()
	..()
	if(active && !cooldown)
		playsound(src.loc, 'lambda/sanecman/sound/lifeweb/klaxon_alarm.ogg',50,0, 30, 30)
		cooldown = TRUE
		spawn(80)
			cooldown = FALSE

/obj/machinery/emergency_room/attack_hand(mob/living/human/user as mob)
