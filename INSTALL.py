...
os.system("apt install make git unzip python3 python3-pip lib32z1 lib32ncurses5 libc6-i386 lib32stdc++6")
...
if not exists:
	os.system("wget http://www.byond.com/download/build/{}/{}.{}_byond_linux.zip".format(byond_version_major,byond_version_major,byond_version_minor))
os.system("unzip {}.{}_byond_linux.zip".format(byond_version_major,byond_version_minor))
os.system("mkdir /usr/share/man/man6")
os.system("make install -C byond")
print("Cloning the github...")
os.system("git clone https://github.com/civ13/civ13 civ13-git")
...
print("Run python3 {}/scripts/launch.py to start the server!".format(cdir))